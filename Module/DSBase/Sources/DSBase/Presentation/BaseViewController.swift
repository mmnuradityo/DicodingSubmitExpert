...
extension UIViewController {
  public func addToSubView(_ stackView: UIStackView, items views: UIView...) {
    for view in views {
  ...
  public func addToSubView(items views: UIView...) {
    for view in views {
  ...
  public func displayToast(_ message: String, width: CGFloat) {
