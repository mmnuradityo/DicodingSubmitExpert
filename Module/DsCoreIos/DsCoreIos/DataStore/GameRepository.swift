...
extension GameRepository: GameRepositoryProtocol {
  ...
  public func getAllGamesFavorite() -> AnyPublisher<[GameModel], Error> {
    return getAllGames()
      .map { games in games.filter { $0.isFavorite } }
      .eraseToAnyPublisher()
  }
  
  public func getGamesDetail(id: Int) -> AnyPublisher<GameModel, Error> {
  ...
  public func updateGamesDetail(game: GameModel) -> AnyPublisher<GameModel, Error> {
    return localDB.update(GameMapper.modelToEntity(game: game))
      .map { GameMapper.entityToModel(entity: $0) }
      .eraseToAnyPublisher()
  }
  
  public func startDownloadImage(game: GameModel) -> AnyPublisher<GameModel, Never> {
  ...
  public func searchGames(name: String) -> AnyPublisher<[GameModel], Error> {
  ...
  private func addOrUpdateBySearch(
  ...
  public func searchFavoriteGames(name: String) -> AnyPublisher<[GameModel], Error> {
