...
public class SearchViewBar: NSObject {
  ...
  public func showOrHideSearchBar(isShow: Bool) {
  ...
  public func observeSearch(complation: @escaping ([GameModel]?, Bool?, String?) -> Void) {
...
extension SearchViewBar {
  @objc public func runSearch() {
    loadSearch()
  }
  
  @objc public func showSearchBar(sender: UIBarButtonItem) {
    showOrHideSearchBar(isShow: true)
  }
  
  @objc public func hideSearchBar(sender: UIBarButtonItem) {
