...
public protocol ImageUtils {
  func getImageData(from: String) -> Data?
}

public class ImageUtilsImplementation: ImageUtils {
  
  public init() {
    
  }
  
  public func getImageData(from: String) -> Data? {
    return UIImage(named: from)?.pngData()
  }
}

extension UIImage {
  public func resize(Size sizeImage: CGSize) -> UIImage? {
    let frame = CGRect(
      origin: CGPoint.zero,
